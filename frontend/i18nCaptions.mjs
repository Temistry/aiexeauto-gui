export const i18nCaptions = {
    "ko": {
        ...
        "openaiIsMustSet": "Retrieval 기능의 사용을 위해 OpenAI API 키도 함께 설정해야 합니다.",
    ...
    "en": {
        ...
        "openaiIsMustSet": "OpenAI API key must be set to use the Retrieval function as well.",
    ...
    "ja": {
        ...
        "openaiIsMustSet": "Retrieval 機能の使用には OpenAI API キーの設定も必要です。",
    ...
    "vi": {
        ...
        "openaiIsMustSet": "Không thể sử dụng hàm Retrieval mà không có khóa API OpenAI.",
